...
```
java -jar /Users/stefan/apps/ili2gpkg-4.3.1/ili2gpkg-4.3.1.jar --dbfile religionsgemeinschaften_edit.gpkg --strokeArcs --defaultSrsCode 2056 --createFk --modeldir ".;http://models.geo.admin.ch" --models SO_AGS_Religionsgemeinschaften_20220422  --export fubar.xtd
```